...
describe('PATCH todos/:id', () => {
    it('should update the todo', done => {
        ...
        let text = "Testing porpouse todo";
    ...
    it('should create a user', done => {
        ...
        request(app)
            ...
            .end(err => {
                ...
                User.findOne({email: mockedUser.email}).then(user => {
                    expect(user).toBeTruthy();
                    expect(user.password).not.toBe(mockedUser.password);
                    done();
                }).catch(e => done(e));
            });
    });
...
describe('DELETE /users/me/token', () => {
    it('should remove auth toen on logout', done => {
        request(app)
